...
import "./Todo.css";
function Todo() {
  const { todos, loading, error, createTodo, deleteTodo, updateTodo } =
    useTodo();
  ...
  async function handleSave(todo) {
    ...
    await updateTodo(todo.id, editingTitle, todo.completed);
    setEditingId(null);
    setEditingTitle("");
  }
  return (
    <div className="todo-page">
      <div className="todo-container">
        ...
        {loading && <p className="todo-loading">Chargement des tâches...</p>}
              ...
              {editingId === todo.id ? (
                ...
                <>
                  ...
                  <div className="todo-actions">
                    ...
                    >
                      {todo.completed ? "Marquer non terminée" : "Terminer"}
                    </button>
                  </div>
                </>
              )}
